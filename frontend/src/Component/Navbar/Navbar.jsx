...
//       try {
//         const response = await axios.get('http://192.168.1.109:3000/api/user/profile', { withCredentials: true }); // Request includes cookies
//         if (response.data) {
...
//     try {
//       // Request to clear the authentication cookie on the backend
//       await axios.post('http://192.168.1.109:3000/api/user/logout', {}, { withCredentials: true });

//       // Set authentication to false on logout

...
//         console.log('Fetching user data...');
//         const response = await axios.get('http://192.168.1.109:3000/api/user/profile', {
//           withCredentials: true, // This sends HTTP-only cookies automatically
//         });
//         console.log('User data fetched:', response.data);
//         setUser(response.data); // Update user state with the response data
//       } catch (error) {
...
//     // You no longer need to check for tokens in localStorage
//     fetchCartData(); // Fetch cart data normally
//     fetchUserData(); // Fetch user data based on the HTTP-only cookie
